...
1. freezes the object's current ordinary parameter containers into a local snapshot;
...
5. resolves them with the supplied Context and invokes the user function.
